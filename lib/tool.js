 ...
 * @return {*}
 */
exports.deepmerge = (...rest) => deepmergeOrigin.all(rest, {arrayMerge: (destinationArray, sourceArray, options) => sourceArray});
 ...
 * @returns {*}
 */
exports.ltrimSlash = (str) => str.replace(/^\//g, '');
 ...
 * @returns {*}
 */
exports.trimSlash = (str) => str.replace(/^\//g, '').replace(/\/$/g, '');
 ...
 * @return {*}
 */
exports.resolveAppPath = (dirname) => {
    const appDirectory = fs.realpathSync(process.cwd());
    const resolveApp = relativePath => path.resolve(appDirectory, relativePath);

    return resolveApp(dirname || ".");
};
